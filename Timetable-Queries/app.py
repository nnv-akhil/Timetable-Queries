...
def admin_form1():
    ...
    # print(csv_file)
    # return "hello"
    return exec(f"{dept}.reg_teacher(teacher_name,csv_file)")
    # ans=
...
def admin_form2() :
    teacher_name = request.form.get("teacher_name")
    return exec(f"{dept}.drop_teacher(teacher_name)")
    #print(teacher_name)
    #return jsonify(result=ans)
...
def admin_form3():
    ...
    return exec(f"{dept}.edit_teacher(teacher_name,csv_data)")
    # print(teacher_name)
    # print(csv_data)
    #return jsonify(result=ans)
...
def admin_form8():
    place_name = request.form.get("place_name")
    return exec(f"{dept}.del_place(place_name)")
    # print(place_name)
    # return "Data received successfully"
...
def student_form1():
    ...
    # print(csv_file)
    # return "hello"
    return exec(f"{dept}.get_teacher_now(teacher_name)")
    # ans=
    # return jsonify(result=ans)
    #return "Data received successfully"
...
def student_form3():
    subject_name = request.form.get("subject_name")
    return exec(f"{dept}.get_teachers_from_subject(subject_name)")
    # print(teacher_name)
    # print(csv_data)
    #return jsonify(result=ans)
...
def student_form8():
    ...
    return exec(f"{dept}.get_teachers_from_aoi(aoi)")
