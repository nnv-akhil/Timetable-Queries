...
function query1() {
    ...
    var myFormData = $("#filterInput1c")[0].files[0];
    // var formData1=new FormData($('#filterInput1c')[0]);
    // var myFormData={form_data: $("#form_data1").val()};
    // // var timetableFile = $('#filterInput1c').val();
    console.log(typeof(myFormData));
    var formData = new FormData();
    formData.append('teacher_name', teacherName);
    formData.append('csv_data', myFormData);
